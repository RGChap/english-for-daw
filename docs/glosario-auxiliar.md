...
| **Consulta** | Query | - | - | Petición a la base de datos |
| **Contraseña** | Password | - | - | Sustantivo |
| **Crear** | - | To create | Created | Verbo |
| **Credenciales** | Credentials | - | - | Usuario + contraseña o token |
| **Dar estilo** | - | To style | Styled | Aplicar CSS / diseño |
| **Datos** | Data | - | - | **¡Sin 's'!** (*The data is...*) |
| **De / Desde** | From | - | - | Preposición de origen (*from the DB*) |
| **Denegar / Rechazar** | - | To deny | Denied | Rechazar acceso (*Access denied*) |
| **Desarrollador/a** | Developer | - | - | Sustantivo |
| **Diseño / Estructura** | Layout | - | - | Estructura visual de la pantalla |
| **Ejecutar** | - | To execute | Executed | Correr código o consultas |
| **Encriptar / Cifrar** | - | To encrypt | Encrypted | Cifrar datos o contraseñas |
| **Enviar (General / HTTP)** | - | To send | Sent | Verbo irregular |
| **Estado (Interfaz)** | State | - | - | Datos temporales de la pantalla |
| **Estado (Servidor)** | Status | - | - | Ej: *Status 200 OK* |
| **Fallo / Error de código** | Bug | - | - | **Basta decir *bug*** (usa *fix a bug*) |
| **Incidencia / Problema** | Issue | - | - | Tarea o reporte (usa *resolve an issue*) |
...
| **Registro / Fila** | Record | - | - | Fila de datos en una tabla |
| **Renderizar / Dibujar** | - | To render | Rendered | Dibujar elementos en pantalla |
| **Repositorio** | Repository / Repo | - | - | Sustantivo |
| **Respuesta** | Response | - | - | Respuesta del servidor |
